...
const kpis = [
  { id: "inversion", label: "Inversión Social Acumulada", value: "$250,000", unit: "MXN", change: "+12.5% vs año anterior", icon: Briefcase, iconBg: "bg-[#DA291C]/10", iconColor: "text-[#DA291C]" },
